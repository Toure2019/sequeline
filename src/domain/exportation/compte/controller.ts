...
export default async (req: Request, res: Response) => {
  ...
  const data = await Service.getData(request.userId, request.etablissement)
  ...
  res.set('content-Disposition', 'attachment;filename="liste_comptes.csv"')
